...
import { Database, Wand2, ArrowRight, Sparkles, LayoutGrid, Bot, PenTool } from "lucide-react";
...
export default function CreateHubPage() {
  ...
  return (
    <div className="min-h-[100dvh] bg-[#FAFAFA] flex flex-col font-sans relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 md:p-12 relative z-10">
        ...
        <motion.div 
          ...
          initial="hidden"
          animate="show"
          className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-[1400px] px-4"
        >
          ...
          >
            ...
            <h2 className="text-xl font-black text-slate-900 mb-3 relative z-10">
              {t.db.title}
            </h2>
            
            <p className="text-[14px] text-slate-500 mb-10 relative z-10 font-medium leading-relaxed">
              {t.db.desc}
            </p>
